...
/**
 * Incrementally search through the index of the document
 *
 * Opens a search prompt; typing selects and expands matching entries, Up and
 * Down cycle through them and Return jumps to the selected one.
 *
 * @param session The used girara session
 * @param argument The used argument
 * @param event Girara event
 ...
 * @return true if no error occurred otherwise false
 */
bool sc_index_search(girara_session_t* session, girara_argument_t* argument, girara_event_t* event, unsigned int t);
